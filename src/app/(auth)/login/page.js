        ...
        <div className="w-full p-12 m-auto bg-white rounded-md shadow-md lg:max-w-lg ">
            ...
            <form className="space-y-6" onSubmit={handleSubmit} >
                <div>
                    ...
                    <input type="text" placeholder="Email Address" className="w-full input input-bordered input-primary bg-white" required />
                </div>
                <div>
                    <label className="label">
                    ...
                    <input type="password" placeholder="Enter Password"
                        className="w-full input input-bordered input-primary bg-white" required />
                </div>
                <div >
                <a href="#" className="text-xs text-gray-600 hover:underline hover:text-blue-600 ">Forget Password?</a><br/>
                <a href="#" className="text-xs text-gray-600 hover:underline hover:text-blue-600">You don't have account? Sign-up</a>
                </div>
                <div>
